...
module.exports = {
  ...
  run: async (bot, interaction) => {
    ...
    const attachment = new AttachmentBuilder("../../../images/rules.png", {
      name: "rules.png",
    });
    ...
    const rule10 = new EmbedBuilder()
      .setAuthor({
        name: "Rule 10",
        iconURL: "https://i.imgur.com/zewbedC.jpg",
      })
      .setColor(colors.RULESEMBED)
    ...
    const rule11 = new EmbedBuilder()
      .setAuthor({
        name: "Rule 11",
        iconURL: "https://i.imgur.com/E77a9nu.jpg",
      })
      .setColor(colors.RULESEMBED)
    ...
    const rule12 = new EmbedBuilder()
      .setAuthor({
        name: "Rule 12",
        iconURL: "https://i.imgur.com/frzALHM.jpg",
      })
      .setColor(colors.RULESEMBED)
    ...
    const information = new EmbedBuilder()
      .setAuthor({
        name: "Information",
        iconURL: "https://i.imgur.com/jn8YaUK.png",
      })
                ...
                webhook.send({
                  embeds: [
                    new EmbedBuilder()
                      .setAuthor({
                        name: "Welcome!",
                        iconURL: "https://i.imgur.com/z3Ppq8B.png",
                      })
                      .setColor("DarkButNotBlack")
                      .setDescription(
      ...
      case "support":
        {
          ...
          const embed3 = new EmbedBuilder()
            .setColor("Green")
            .setDescription(
              'Before opening a ticket, please review the information above. \n\n✅ - To open a ticket, click the "📩 Create ticket" button below!'
            )
            .setFooter({ text: `${config.messageSettings.signature} ` });
